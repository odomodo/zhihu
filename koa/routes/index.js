...
router.get('/', async (ctx, next) => {
  const  getZhihu = async () => {
    ...
    let config = {
      method: 'get',
      url:`https://www.zhihu.com/api/v3/feed/topstory/recommend?session_token=b92e76f1d1ef60fd381853858680bfca&desktop=true&page_number=${page_number}&limit=${limit}&action=down&after_id=11&ad_interval=-10`,
      headers
    }
